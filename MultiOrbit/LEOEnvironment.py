...
def create_Constellation(specific_constellation, env):
    ...
    if specific_constellation in ("intelsat", "Intelsat"):
        # GEO slots (first satellite fixed at 91W as requested).
        geo_slots_deg = [-91.0, -89.0, -45.0, 0.0, 45.0]
