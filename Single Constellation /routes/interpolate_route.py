...
def main():
    ...
    route_file = os.path.join(base_dir, 'route.csv')
    if not os.path.exists(route_file):
        # Fallback if script is invoked from an unexpected working layout.
        route_file = os.path.join(os.path.dirname(base_dir), 'route.csv')
    output_file = os.path.join(base_dir, 'route_10s_interpolated.csv')
